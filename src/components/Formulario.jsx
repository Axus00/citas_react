    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form  onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
            ...
            <div className="mb-5">
                ...
                <input id="propietario" type="text" placeholder="Nombre de la Mascota" 
            ...
            <div className="mb-5 ">
                ...
                <textarea id="Síntomas" type="text" placeholder="Describe los Síntomas" 
                className="border-2 w-full p-2 mt-2 placeholder:gray-400 rounded-md"
                value={sintomas}
                onChange={ (e) => setSintomas(e.target.value) }/>
            </div>

            <input type="submit" className="bg-indigo-600 w-full rounded-md p-3
